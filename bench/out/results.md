...
|---|-------|----------|---------|
| 1 | full_backfill | 125s, 5180 ev/s, all counts exact | PASS |
| 2 | first_report | p50 14.4 ms / p95 21.3 ms, all numbers exact | PASS |
| 3 | progressive | correct 30d/90d report 16.0s after empty db | PASS |
| 4 | duplicate_storm | 50k dups -> 0 extra rows, checksums identical | PASS |
| 5 | kill_resume | killed at 40%, final drift 0 cents | PASS |
| 6 | segmentation | p50 121.2 ms over 60460 customers | PASS |
...
- wall time: 125.1s for 648191 events (5180 events/sec, pages of 100, commit + checkpoint per page)
...
- latency over 20 runs: p50 14.4 ms, p95 21.3 ms on the full 500k-charge dataset
- refund rate: 4.20%
...
- time-to-first-correct-report: 16.0s from an empty database (vs full backfill of the whole history)
...
- replayed 50000 random already-processed events through the same apply path in 1.4s (36684 events/sec)
...
- killed worker (TerminateProcess) at checkpoint 260500 / 648191 events (40.2%)
- restart resumed from checkpoint 260500 and finished the remaining 387691 events in 74.7s
...
- latency over 20 runs: p50 121.2 ms, p95 137.5 ms
