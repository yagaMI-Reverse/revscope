...
- wall time: 138.4s for 648191 events (4683 events/sec, pages of 100, commit + checkpoint per page)
...
- latency over 20 runs: p50 13.6 ms, p95 15.2 ms on the full 500k-charge dataset
- refund rate: 4.20%
...
- time-to-first-correct-report: 17.3s from an empty database (vs full backfill of the whole history)
...
- replayed 50000 random already-processed events through the same apply path in 1.4s (37034 events/sec)
...
- killed worker (TerminateProcess) at checkpoint 260100 / 648191 events (40.1%)
- restart resumed from checkpoint 260100 and finished the remaining 388091 events in 82.6s
...
- latency over 20 runs: p50 119.0 ms, p95 121.8 ms
